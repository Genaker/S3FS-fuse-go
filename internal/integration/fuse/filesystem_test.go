...
// TestRenameLargeFile tests renaming a large file (triggers multipart copy)
func TestRenameLargeFile(t *testing.T) {
	fs := integration.SetupTestFilesystem(t, integration.LocalStackBucket, integration.LocalStackRegion)
	ctx := context.Background()
...
// TestRenameNonExistent tests renaming a non-existent file
...
// TestUtimens tests setting file times
...
// TestUtimensDirectory tests setting times on a directory
func TestUtimensDirectory(t *testing.T) {
	fs := integration.SetupTestFilesystem(t, integration.LocalStackBucket, integration.LocalStackRegion)
	ctx := context.Background()
...
// TestWriteFileAppend tests appending to a file
...
// TestWriteFileTruncate tests truncating a file
...
// TestWriteFileLarge tests writing a large file
...
// TestWriteFileMiddle tests writing to middle of file
func TestWriteFileMiddle(t *testing.T) {
	fs := integration.SetupTestFilesystem(t, integration.LocalStackBucket, integration.LocalStackRegion)
	ctx := context.Background()
...
// TestSetXattr tests setting extended attributes on a file
...
// TestGetXattr tests getting extended attributes
...
// TestGetXattrNonExistent tests getting non-existent extended attribute
func TestGetXattrNonExistent(t *testing.T) {
	fs := integration.SetupTestFilesystem(t, integration.LocalStackBucket, integration.LocalStackRegion)
	ctx := context.Background()
...
// TestListXattr tests listing extended attributes
...
// TestRemoveXattr tests removing extended attributes
...
// TestXattrDirectory tests extended attributes on directories
func TestXattrDirectory(t *testing.T) {
	fs := integration.SetupTestFilesystem(t, integration.LocalStackBucket, integration.LocalStackRegion)
	ctx := context.Background()
...
// TestMkdirNested tests creating nested directories
...
// TestRmdirWithMarker tests removing directory with .keep marker
func TestRmdirWithMarker(t *testing.T) {
	fs := integration.SetupTestFilesystem(t, integration.LocalStackBucket, integration.LocalStackRegion)
	ctx := context.Background()
